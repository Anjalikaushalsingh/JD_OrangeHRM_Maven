...
public class CaptureScreenShot_Example {
	...
	String Relativepath_failure = filePath_failure+"\\ScreenShot_Fail";
	String filePath_Success = filePath_failure+"\\ScreenShot_Pass";
	@Test(priority=2)
	public void OrangeHRM_Login() throws Exception
	{
		...
		driver.findElement(By.name("txtPassword")).sendKeys("admin123");// admin 123 = correct
	...
	public void LaunchBrowser() throws InterruptedException
		...
		driver.navigate().to("https://mvnrepository.com/artifact/org.apache.poi/poi-ooxml/4.1.2");
		Thread.sleep(3000);
		}
