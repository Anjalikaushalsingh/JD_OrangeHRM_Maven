...
public class OrangeHRM_Login_Incognito {
	ChromeDriver driver;
	 WebDriverWait wait;
...
//			driver.findElement(By.name("username")).sendKeys("uvgjauz");
//			driver.findElement(By.id("okta-signin-password")).sendKeys("Manila1234567");
